 ...
 * antes, `apps/web/app/m/[token]/page.tsx` hacía este encadenado inline, y nada cubría
 ...
 * copy-paste -- no lo detectaba nada de eso, y el e2e "no leak" tampoco: `CartClient`
